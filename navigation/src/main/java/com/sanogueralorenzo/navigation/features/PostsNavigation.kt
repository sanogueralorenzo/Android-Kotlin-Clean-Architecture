...
object PostsNavigation : DynamicFeature<Intent> {
    ...
    private const val POST_LIST = "com.sanogueralorenzo.posts.presentation.postlist.PostListActivity"
    private const val POST_DETAILS = "com.sanogueralorenzo.posts.presentation.postdetails.PostDetailsActivity"
