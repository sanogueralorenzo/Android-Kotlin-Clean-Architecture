        ...
        fragment.viewLifecycleOwnerLiveData.observe(fragment, { viewLifecycleOwner ->
            viewLifecycleOwner.lifecycle.addObserver(object : LifecycleObserver {
                ...
                fun onDestroy() {
                    ...
                    // in case we need to do cleanup so we clear the reference one frame later.
 ...
 *
 * To use, just call inside your fragment (at the top of the fragment):
 * private val binding: ExampleFragmentBinding by viewBinding()
 *
 * The name is generated from the layout file itself, from above it would be -> example_fragment.xml
 *
 * @see com.sanogueralorenzo.views.screen.ContainerFragment for an example
 *
 * Apart from the binding, fragments still need to have the layout passed through the constructor for inflation
 *
